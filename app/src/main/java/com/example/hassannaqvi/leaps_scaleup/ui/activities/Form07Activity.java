...
public class Form07Activity extends AppCompatActivity {
    ...
    private void SaveDraft() throws JSONException {
        ...
        f07.put("ls0712",bi.ls07id11.getText().toString());

        f07.put("ls0713                                                                                                                                                                                          ",bi.ls07id12a.isChecked()? "1"
        ...
        f07.put("ls0714                                                                                                                                                                                          ",bi.ls07id12a.isChecked()? "1"
                ...
                : "0" );
        f07.put("ls071496x",bi.ls07id1296x.getText().toString());

        f07.put("ls0715",bi.ls07id13.getText().toString());

        f07.put("ls0716",bi.ls07id14a.isChecked()? "1"

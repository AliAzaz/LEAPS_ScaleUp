...
public class ScheduleService06 extends JobService {
    @Override
    public boolean onStartJob(final JobParameters jobParameters) {
        ...
        new GetAllDBData(db, GetFncDAO.class.getName(), "getFncDao", "getUnSyncedForms_04_05") {
            ...
            protected void onPostExecute(Collection<?> objects) {
                new SyncAllData(
                        ScheduleService06.this,
                        "Forms06",
                        "updateSyncedForms_04_05",
                        Forms_04_05.class,
                        MainApp.buildUrl(CONSTANTS.URL_FORMS.replace(".php", MainApp.FORM06 + ".php"))
                        , objects
                ) {
                    @Override
